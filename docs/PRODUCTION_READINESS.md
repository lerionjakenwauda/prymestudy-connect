...
- production integration activation requires PrymeStudy approval;
...
Before production access is approved, the partner must pass the certification matrix in `PARTNER_CERTIFICATION.md` using a sandbox integration.
